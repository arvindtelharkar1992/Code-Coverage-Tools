//References: http://stackoverflow.com/questions/1303646/check-whether-variable-is-number-or-string-in-javascript
...
/*
    ...
    var stringarray=[];
    var composeArray=[];
    var test='12423543263467547';
    var req=test.substring(1,4);
    for(var index=0;index<req.length;index++){
    	composeArray.push(req.charAt(index));
    }

    console.log("The composeArray is : " + composeArray);

    nostring=permute(composeArray);

    
    for(array in nostring){
        stringarray.push(JSON.stringify(array));
    }
...
*/
	...
	for ( var funcName in functionConstraints )
	{
        ...
        //console.log("Permutations : "+nostring);
